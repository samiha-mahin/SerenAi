...
export default function home() {
  const emotions = [
    { value: 0, label: "🍂 Down", color: "from-red-500/50" },
    { value: 25, label: "🌛 Contentment", color: "from-yellow-500/50" },
    { value: 50, label: "🌷 Peaceful", color: "from-purple-500/50" },
    { value: 75, label: "🍀 Happy", color: "from-green-500/50" },
    { value: 100, label: "🐬 Excited", color: "from-blue-500/50" },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      <section className="relative min-h-[90vh] mt-20 flex flex-col items-center justify-center py-12 px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm border border-[#8BD3E6] bg-transparent backdrop-blur-sm hover:border-[#5bafc7] transition-all duration-300">
            <Waves className="w-4 h-4 animate-wave text-[#5bafc7] dark:text-[#8BD3E6]" />
            <span className="relative text-[#5bafc7] dark:text-[#8BD3E6] after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[1px] after:bg-[#8BD3E6] after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300">
          ...
          >
            <div className="space-y-2 text-center">
              <p className="text-sm text-[#5bafc7]  font-medium">
              ...
              <div className="flex justify-between items-center px-2">
                {emotions.map((em) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-[#5bafc7]  mt-1 font-medium">
                      {em.label.split(" ")[1]}
                    </div>
                  </div>
                ))}
            ...
            <div className="relative px-2">
              ...
              <Slider
                ...
                max={100}
                step={1}
                className="py-4 fill-[#5bafc7]"
              />
            </div>
            <div className="text-center">
              <p className="text-sm text-[#8BD3E6] animate-pulse">
          ...
          >
            <Button
              ...
              className="relative group h-12 px-8 rounded-full bg-gradient-to-r  from-[#5bafc7] to-[#8BD3E6]  transition-all duration-500 hover:shadow-xl hover:shadow-primary/30"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 relative">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="group relative overflow-hidden border border-[#8BD3E6] hover:border-[#5bafc7] transition-all duration-300 h-[200px] bg-card/30 dark:bg-card/80 backdrop-blur-sm">
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${feature.color} to-transparent opacity-0 group-hover:opacity-60 transition-opacity duration-500 dark:group-hover:opacity-80`}
                  />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#5bafc7]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                </Card>
              </motion.div>
            ))}
          </div>
